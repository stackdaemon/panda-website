...
- যখন তুমি কোনো child element-এ event (যেমন click) দাও, তখন সেটি প্রথমে ওই child element-এ কাজ করে।তারপর event টি bubble হয়ে তার parent element এ পৌঁছায়।parent থেকে আবার তার parent (grandparent)-এ যায়। এভাবে একে একে সব parent element হয়ে document পর্যন্ত পৌঁছায়।
...
- তুমি parent element-এ একটা event listener attach করো। যখন কোনো child element-এ event ঘটে, সেই event bubble হয়ে parent এ আসে। parent element-এর ভিতরে দেখে নেয় কোন child element থেকে event এসেছে (event.target দিয়ে চেক করা হয়)। তারপর সেই child element অনুযায়ী action নেওয়া হয়।
